        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    username = table.Column<string>(name: "user_name", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    actioncontent = table.Column<string>(name: "action_content", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    actiontime = table.Column<DateTime>(name: "action_time", type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    asnno = table.Column<string>(name: "asn_no", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    asnbatch = table.Column<string>(name: "asn_batch", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    estimatedarrivaltime = table.Column<DateTime>(name: "estimated_arrival_time", type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    seriesnumber = table.Column<string>(name: "series_number", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    putawayqty = table.Column<int>(name: "putaway_qty", type: "int", nullable: false),
                    creator = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    createtime = table.Column<DateTime>(name: "create_time", type: "datetime(6)", nullable: false),
                    lastupdatetime = table.Column<DateTime>(name: "last_update_time", type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lastupdatetime = table.Column<DateTime>(name: "last_update_time", type: "datetime(6)", nullable: false),
                    tenantid = table.Column<long>(name: "tenant_id", type: "bigint", nullable: false),
                    pickcheckerid = table.Column<int>(name: "pick_checker_id", type: "int", nullable: false),
                    pickchecker = table.Column<string>(name: "pick_checker", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    menu = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    flowname = table.Column<string>(name: "flow_name", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    creator = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    createtime = table.Column<DateTime>(name: "create_time", type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    tablename = table.Column<string>(name: "table_name", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    prefixchar = table.Column<string>(name: "prefix_char", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    resetrule = table.Column<string>(name: "reset_rule", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    currentno = table.Column<int>(name: "current_no", type: "int", nullable: false),
                    lastupdatetime = table.Column<DateTime>(name: "last_update_time", type: "datetime(6)", nullable: false),
                    tenantid = table.Column<long>(name: "tenant_id", type: "bigint", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tenantid = table.Column<long>(name: "tenant_id", type: "bigint", nullable: false),
                    menuactions = table.Column<string>(name: "menu_actions", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lastupdatetime = table.Column<DateTime>(name: "last_update_time", type: "datetime(6)", nullable: false),
                    tenantid = table.Column<long>(name: "tenant_id", type: "bigint", nullable: false),
                    menuactionsauthority = table.Column<string>(name: "menu_actions_authority", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    putawaydate = table.Column<DateTime>(name: "putaway_date", type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    vuepath = table.Column<string>(name: "vue_path", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    tabpage = table.Column<string>(name: "tab_page", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    solutionname = table.Column<string>(name: "solution_name", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    configjson = table.Column<string>(name: "config_json", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    reportlength = table.Column<decimal>(name: "report_length", type: "decimal(65,30)", nullable: false),
                    reportwidth = table.Column<decimal>(name: "report_width", type: "decimal(65,30)", nullable: false),
                    reportdirection = table.Column<string>(name: "report_direction", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    lastupdatetime = table.Column<DateTime>(name: "last_update_time", type: "datetime(6)", nullable: false),
                    tenantid = table.Column<long>(name: "tenant_id", type: "bigint", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    asnmasterid = table.Column<int>(name: "asnmaster_id", type: "int", nullable: false),
                    asnno = table.Column<string>(name: "asn_no", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    asnstatus = table.Column<byte>(name: "asn_status", type: "tinyint unsigned", nullable: false),
                    ...
                    actualqty = table.Column<int>(name: "actual_qty", type: "int", nullable: false),
                    arrivaltime = table.Column<DateTime>(name: "arrival_time", type: "datetime(6)", nullable: false),
                    unloadtime = table.Column<DateTime>(name: "unload_time", type: "datetime(6)", nullable: false),
                    unloadpersonid = table.Column<int>(name: "unload_person_id", type: "int", nullable: false),
                    unloadperson = table.Column<string>(name: "unload_person", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    sortedqty = table.Column<int>(name: "sorted_qty", type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    seriesnumber = table.Column<string>(name: "series_number", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    pickerid = table.Column<int>(name: "picker_id", type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    flowsetmainid = table.Column<int>(name: "flowsetmain_id", type: "int", nullable: false),
                    isorigin = table.Column<bool>(name: "is_origin", type: "tinyint(1)", nullable: false),
                    isend = table.Column<bool>(name: "is_end", type: "tinyint(1)", nullable: false),
                    nodeguid = table.Column<string>(name: "node_guid", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    nodename = table.Column<string>(name: "node_name", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    prevnodeguid = table.Column<string>(name: "prev_node_guid", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    flowsetid = table.Column<int>(name: "flowset_id", type: "int", nullable: false),
                    flowsetmainid = table.Column<int>(name: "flowsetmain_id", type: "int", nullable: false),
                    nodeguid = table.Column<string>(name: "node_guid", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    c1 = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    collabel = table.Column<string>(name: "col_label", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    colname = table.Column<string>(name: "col_name", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    c2 = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    sort = table.Column<int>(type: "int", nullable: false),
                    conditiongroup = table.Column<string>(name: "condition_group", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    formulas = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    assertmode = table.Column<string>(name: "assert_mode", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    tablename = table.Column<string>(name: "table_name", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    schemename = table.Column<string>(name: "scheme_name", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    skuid = table.Column<int>(name: "sku_id", type: "int", nullable: false),
                    warehouseid = table.Column<int>(name: "warehouse_id", type: "int", nullable: false),
                    safetystockqty = table.Column<int>(name: "safety_stock_qty", type: "int", nullable: false)
                },
                constraints: table =>
                {
